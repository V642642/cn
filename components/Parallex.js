...
import howItWorks from "../public/images/how-it-works.webp"
...
export default function Parallex() {
  ...
  return (
    <>
      ...
      <div id="howitworks" className="flex bg-fixed bg-no-repeat bg-cover bg-[50%]  w-full gap-2 items-center bg-parallex  justify-center">
        <div className="w-full md:w-8/12 py-14 flex items-center justify-around gap-5 flex-col md:flex-row">
          <div className="flex items-center justify-center py-10 flex-col gap-6">
            <div  onClick={() => setOpen({employer : true , agency : false})} className="w-[150px] cursor-pointer h-[150px] flex items-center justify-center rounded-full border-4 border-green-700">
              <FontAwesomeIcon
                icon={faPlay}
          ...
          <div className="flex items-center justify-center py-10 flex-col gap-6">
            <div onClick={() => setOpen({employer : false , agency : true})} className="w-[150px] cursor-pointer h-[150px] flex items-center justify-center rounded-full border-4 border-green-700">
              <FontAwesomeIcon
                icon={faPlay}
