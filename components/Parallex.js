    ...
    <>
      ...
      <div className="w-full flex items-center justify-center py-14 bg-blue-600 flex-col md:flex-row">
        <div className="flex w-full md:w-4/12 text-white items-center justify-center flex-col">
          ...
          <p className="text-center font-primary text-[20px] font-medium">
            Power-up with RaaS<sup>TM</sup> for faster hiring.
          </p>
          <p className="text-center font-primary">
            Introducing the RaaSTM - `&apos;`Recruitment as a Service`&apos;`
            Marketplace, an online recruitment platform which enables you to
            engage with multiple Recruiting agencies to fulfil your job
            requirements by getting access to a large pool of passive candidates
            and array of integrated tools resulting in faster hiring.
          </p>
        </div>
