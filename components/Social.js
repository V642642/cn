...
export default function Social() {
  return (
    <div className="md:flex hidden bg-fixed bg-no-repeat bg-cover bg-[50%]  w-full gap-12 items-center bg-social py-20 justify-center flex-col border-t-8 min-h-[400px] border-green-500">
