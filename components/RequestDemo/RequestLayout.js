...
export default function RequestLayout() {
  ...
  return (
    <div className="min-h-[100vh] py-20 sm:py-1 font-primary mt-10 flex items-center justify-center">
      <div className=" flex items-center  justify-center flex-col md:flex-row gap-8 lg:w-10/12 w-[95%]">
        <div className="w-full bg-gradient-to-b gap-4 from-rose-100 to-teal-100 flex md:w-[50%] rounded-[8px] sm:p-28 flex-col items-center justify-center">
          ...
          >
            <source src={`${process.env.NEXT_PUBLIC_S3_URL}/hp.mp4`} type="video/mp4"></source>
          </video>
        </div>
        <div className="w-full  md:p-28 flex md:w-[50%] flex-col items-center justify-start">
