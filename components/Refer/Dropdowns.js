...
export default function Dropdowns() {
  ...
  return (
    <div className="w-full font-primary gap-4 flex py-10 lg:w-8/12 justify-center flex-col items-start">
      <div
        onClick={() => handletoggle(1)}
        className="text-[25px] w-full cursor-pointer bg-slate-100  py-2"
      >
        <p>
          <FontAwesomeIcon icon={faChevronDown} /> Here&apos;s how it works
        </p>
        <div
          className={` ${
      ...
      >
        <p>
          <FontAwesomeIcon icon={faChevronDown} /> You Earning potential (Rs.)
        </p>
        <div
          className={` ${
      ...
      >
        <p>
          <FontAwesomeIcon icon={faChevronDown} /> Some Illustrations (Earning
          potential)
        </p>
        <div
          className={`${
      ...
      >
        <p>
          ...
          <FontAwesomeIcon icon={faChevronDown} /> The Sign-up fee
        </p>
        <div
          className={`${
      ...
      >
        <p>
          <FontAwesomeIcon icon={faChevronDown} /> The Placement fee
        </p>
        <div
          className={` ${
      ...
      >
        <p>
          ...
          <FontAwesomeIcon icon={faChevronDown} /> how much can you earn ?
        </p>
        <div
          className={`${
      ...
      >
        <p>
          ...
          <FontAwesomeIcon icon={faChevronDown} /> Scheme validity
        </p>
        <div
          className={` ${
      ...
      >
        <p>
          <FontAwesomeIcon icon={faChevronDown} /> Terms and conditions of the
          scheme
        </p>
        <div
          className={`  ${
      ...
      >
        <p>
          <FontAwesomeIcon icon={faChevronDown} /> Glossary of terms used
        </p>
        <div
          className={` ${
